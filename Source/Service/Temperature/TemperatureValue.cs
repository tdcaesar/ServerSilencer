...
//    private readonly TemperatureRange _range;
    ...
    private TemperatureValue(int temperature, TemperatureScale scale)
    {
        Value = temperature;
        Scale = scale;
    }
    ...
    public static implicit operator int(TemperatureValue temperatureValue) => temperatureValue.Value;
